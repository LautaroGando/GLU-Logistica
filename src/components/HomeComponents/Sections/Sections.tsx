...
export const Sections: React.FC = () => {
  ...
  return (
    <div className="flex flex-col gap-10">
      <div className="grid grid-cols-1 place-items-center gap-3 sm:grid-cols-2 lg:grid-cols-4">
