...
import { faTruckFast, faUser, IconDefinition } from "@fortawesome/free-solid-svg-icons";
            ...
            return (
              <Link
                ...
                className={`flex gap-[7px] duration-200 transition-all ${
                  isSelected ? "text-admin-green hover:text-admin-green/60" : "text-admin-letterColor hover:text-admin-letterColor/60"
                }`}
              >
                <FontAwesomeIcon
                  icon={item.icon}
